		...
		<AppNavigation>
			...
			<ul>
				<AppNavigationItem
					v-for="note in notes"
					:key="note.id"
					:title="note.title ? note.title : t('skeleton_app', 'New note')"
					...
					<template slot="actions">
						<ActionButton
							...
							{{ t('skeleton_app', 'Cancel note creation') }}
						</ActionButton>
						<ActionButton
							v-else
							icon="icon-delete"
							@click="deleteNote(note)">
							{{ t('skeleton_app', 'Delete note') }}
						</ActionButton>
					</template>
				</AppNavigationItem>
			</ul>
...
export default {
	...
	computed: {
		 ...
		 */
		checkNoteUser() {
			if (this.item.dispName === null) {
				return this.item.user;
			}
			return this.item.dispName;
		},
